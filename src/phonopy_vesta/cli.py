# -*- coding: utf-8 -*-
"""
Phonopy VESTA CLI: Export Eigenvectors from Phonopy format to VESTA.
"""
...
def extract(band_yaml):
    ...
    qpoint_band = np.zeros((nq_point, nbands), dtype=float)
    ...
    displacements = np.zeros((nq_point, nbands, natoms, 3), dtype=float)
    ...
    # Contains frequencies at different q-point
